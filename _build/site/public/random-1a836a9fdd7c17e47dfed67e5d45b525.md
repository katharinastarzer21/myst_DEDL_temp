...
<div id="tag-filter" style="margin-bottom: 20px;">
  <label for="tagSelect"><strong>Filter by tag:</strong></label>
  <select id="tagSelect" onchange="filterCards()" style="margin-left: 10px; padding: 4px;">
    ...
    <option value="DataCube">DataCube</option>
    <option value="Digital Twin">Digital Twin</option>
  </select>
</div>
